...
// #define VA_ARG(ap, t)   (*(t *) ((ap += _INT_SIZE_OF (t)) - _INT_SIZE_OF
// (t))) #define VA_END(ap)      (ap = (VA_LIST) 0) Use the native arguments for
// tools.
...
///
#define ALIGN_POINTER(p, s)                                                    \
  ((VOID *)((UINTN)(p) + (((s) - ((UINTN)(p))) & ((s) - 1))))

///
///  ALIGN_VARIABLE - aligns a variable up to the next natural boundary for int
///  size of a processor
///
