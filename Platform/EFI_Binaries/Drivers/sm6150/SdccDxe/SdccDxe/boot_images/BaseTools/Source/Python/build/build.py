...
class Build():
    ...
    def __init__(self, Target, WorkspaceDir, BuildOptions):
        ...
        self.SpawnMode      = True
        self.BuildReport    = BuildReport.BuildReport(BuildOptions.ReportFile, BuildOptions.ReportType)
    ...
    def InitPreBuild(self):
        ...
        if 'PREBUILD' in list(GlobalData.gCommandLineDefines.keys()):
    ...
    def InitPostBuild(self):
        if 'POSTBUILD' in list(GlobalData.gCommandLineDefines.keys()):
