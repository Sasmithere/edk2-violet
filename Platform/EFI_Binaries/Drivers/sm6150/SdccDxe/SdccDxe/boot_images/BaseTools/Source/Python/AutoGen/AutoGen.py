...
class WorkspaceAutoGen(AutoGen):
    ...
    def _Init(self, WorkspaceDir, ActivePlatform, Target, Toolchain, ArchList, MetaFileDb,
        ...
        for Arch in self.ArchList:
            ...
            SourcePcdDict_Keys = list(SourcePcdDict.keys())
            BinaryPcdDict_Keys = list(BinaryPcdDict.keys())
...
class PlatformAutoGen(AutoGen):
    ...
    def CollectPlatformDynamicPcds(self):
                ...
                for PcdItem in GlobalData.BuildOptionPcd:
                    if (PlatformPcd.TokenSpaceGuidCName, PlatformPcd.TokenCName) == (PcdItem[0], PcdItem[1]):
                        ...
                        if PlatformPcd.SkuInfoList:
                            Sku = PlatformPcd.SkuInfoList[list(PlatformPcd.SkuInfoList.keys())[0]]
        ...
        for pcd in list(self.Platform.Pcds.keys()):
            if pcd not in list(self._PlatformPcds.keys()):
        ...
        if (self.Workspace.ArchList[-1] == self.Arch): 
            ...
            PlatformPcds = list(self._PlatformPcds.keys())
            PlatformPcds.sort()
            #
