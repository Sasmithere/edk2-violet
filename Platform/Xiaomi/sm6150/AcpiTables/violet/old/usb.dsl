Name (QUFN, Zero)
        ...
        Device (URS0)
        {
            ...
            /* Expose HID via a _HID control method that returns URSI() to avoid alias/name collisions */
            Method (_HID, 0, NotSerialized)  // _HID: Hardware ID (returns string from URSI)
            {
                Return (URSI())
            }
